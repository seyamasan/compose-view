...
@Composable
fun SecondView(navController: NavHostController, title: String, modifier: Modifier = Modifier) {
...
fun SecondViewPreview() {
    ...
    ComposeViewTheme {
        Scaffold(modifier = Modifier.fillMaxSize(), containerColor = MaterialTheme.colorScheme.primary) { innerPadding ->
            SecondView(navController = navController, title = "Second Viewだよ", modifier = Modifier.padding(innerPadding))
        }
    }
}